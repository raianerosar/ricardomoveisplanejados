      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Ricardo Móveis</span>
            </div>
            <p className="text-slate-300 mb-4">
              Especialistas em móveis planejados para transformar seus ambientes com qualidade e estilo.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/ricardorosarmoveisplanejados"
                className="w-10 h-10 bg-slate-700 hover:bg-yellow-500 rounded-full flex items-center justify-center transition-colors"
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center">
          <p className="text-slate-400">
            © {currentYear} Ricardo Móveis. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
